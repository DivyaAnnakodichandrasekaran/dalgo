...
public class Tree_page {
	...
	@FindBy (linkText = "Tree")WebElement DropDown_list;
	@FindBy (xpath = "//a[contains(text(),'Introduction')]")WebElement Intro_lnk;
	@FindBy (linkText = "Overview of Trees")WebElement Overview_lnk;
	@FindBy (xpath = "//a[contains(text(),'Terminologies')]")WebElement Terminologies_lnk;
	@FindBy (xpath = "//a[contains(text(),'Types of Trees')]")WebElement TypesofTree_lnk;
	@FindBy (xpath = "//a[contains(text(),'Tree Traversals')]")WebElement TreeTraversals_lnk;
	@FindBy (xpath = "//a[contains(text(),'Traversals-Illustration')]")WebElement TraversalsIllustration_lnk;
	@FindBy (xpath = "//a[contains(text(),'Binary Trees')]")WebElement BinaryTrees_lnk;
	@FindBy (xpath = "//a[contains(text(),'Types of Binary Trees')]")WebElement TypeBinaryTrees_lnk;
	@FindBy (xpath = "//a[contains(text(),'Implementation in Python')]")WebElement ImplementationinPython_lnk;
	@FindBy (xpath = "//a[contains(text(),'Binary Tree Traversals')]")WebElement BinaryTreeTraversals_lnk;
	@FindBy (xpath = "//a[contains(text(),'Implementation of Binary Trees')]")WebElement ImplementationofBinaryTrees_lnk;
	@FindBy (xpath = "//a[contains(text(),'Applications of Binary trees')]")WebElement ApplicationsBinaryTrees_lnk;
	@FindBy (xpath = "//a[contains(text(),'Binary Search Trees')]")WebElement BinarySearchTrees_lnk;
	@FindBy (xpath = "//a[contains(text(),'Implementation Of BST')]")WebElement ImpletentationBST_lnk;
